const pl = {
  ...
  polishDocumentTitle: "Popraw dokument",
  polishDocumentContent:
    "Jesteś ekspertem w edycji i korekcie dokumentów i wiadomości i chcesz pomóc zapewnić, że wiadomość jest jasna i zwięzła poprzez edycję dostarczonej wiadomości.",
